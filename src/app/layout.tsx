...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/draw-a-cartoon-desert-landscape-in-16-9--1759757248075-935acb1e.jpg",
        width: 1200,
        height: 630,
        alt: "MemePulse mascot with buy arrows on a vibrant gradient",
      }
    ],
  },
  twitter: {
    ...
    description: "MemePulse is a playful memecoin with clear, step-by-step buying guidance, friendly tokenomics, and a community-first vibe. Minted for fun, built for ease.",
    images: [
      "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/draw-a-cartoon-desert-landscape-in-16-9--1759757248075-935acb1e.jpg",
    ],
  },
  robots: {
    index: true,
